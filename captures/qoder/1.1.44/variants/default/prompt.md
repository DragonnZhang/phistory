...
- Do not Read or inspect a background agent's output_file path — it is the full transcript and can overflow your context. Wait for the `<task-notification>`, which will contain the agent's findings.
...
```json
{
  ...
  "properties": {
    ...
    "path": {
      "description": "The directory to search in. If not specified, the current working directory and all trusted directories will be searched. IMPORTANT: Omit this field to use the default directories. DO NOT enter \"undefined\" or \"null\" - simply omit it for the default behavior. Must be a valid directory path if provided.",
      "type": "string"
    }
  },
  "required": [
...
```json
{
  ...
  "properties": {
    ...
    "path": {
      "description": "File or directory to search in (rg PATH). Defaults to the current working directory and all trusted directories.",
      "type": "string"
    },
    "glob": {

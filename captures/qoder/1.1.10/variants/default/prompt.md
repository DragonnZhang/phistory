...
Create a new goal with an objective. Do NOT call this when a goal already exists — a goal set via /goal set is already registered and appears as current_goal in your context. Fails if a non-completed goal already exists.

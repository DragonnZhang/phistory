...
- If you want to read a specific file path, use the Read tool instead, to find the answer more quickly
- If you need to locate files by name or path pattern, use the Glob tool instead, to find the match more quickly
- If you are searching for a specific class, function, or symbol definition, use the Grep tool instead, to find the match more quickly
...
```json
{
  ...
  "properties": {
    ...
    "model": {
      "type": "string",
      "description": "Optional model override for this agent. Takes precedence over the agent definition's model."
    },
    "mode": {
      "type": "string",
      "enum": [

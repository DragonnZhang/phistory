...
### Unknown static prompt 66ae30cb


```text
I am triaging GitHub issues for the Qoder CLI project. I need to identify issues that should be closed because they are:
...
### Unknown static prompt 86dab568
...
### Unknown static prompt aef852f7
...
### Unknown static prompt c6aa7b63


```text
${S2({taskId:A,outputPath:H,summary:w,toolUseId:L})}
Last output:
${}
...
```text
# Contextual Instructions (${??[S9]).join(", ")})
